...
export const GET_IDEA_METADATA_REQUEST = 'GET_IDEA_METADATA_REQUEST'
export const GET_IDEA_METADATA_SUCCESS = 'GET_IDEA_METADATA_SUCCESS'
export const GET_IDEA_METADATA_FAILURE = 'GET_IDEA_METADATA_FAILURE'
